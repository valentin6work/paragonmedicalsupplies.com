            ...
            <div class="shipping-and-billing__block-data">
                <div class="shipping-and-billing__block-row">
                    <div class="shipping-and-billing__block-col">
                        <div class="shipping-and-billing__name">
                            <p>Mario Michell</p>
                            <p class="shipping-and-billing__email">mario@mymail.com</p>
                        </div>
                    </div>
                    <div class="shipping-and-billing__block-col">
                        <address>712 Boundary Street
                    ...
                    <div class="shipping-and-billing__block-col">
                        <div class="shipping-and-billing__block-action">
                            ...
                            <button class="remove-btn">
                                <img src="img/close_filter_cell.svg" alt="icon">
                            </button>
                        </div>
                    </div>
                </div>
                <div class="shipping-and-billing__block-row">
                    ...
                    <div class="shipping-and-billing__block-col">
                        <address>3655 Philadelphia Avenue
                            Murray, UT 84107</address>
                    </div>
                    <div class="shipping-and-billing__block-col">
                        <div class="shipping-and-billing__block-action">
                            <button class="address-default-button">Set as default</button>
                            <a href="#" class="edit-link">Edit</a>
                            <button class="remove-btn">
                                <img src="img/close_filter_cell.svg" alt="icon">
                            </button>
                ...
                <form action="#" method="post" class="shipping-and-billing__block-row add_shipping_field_custom form__input-style">
                    <input type="hidden" id="billing_is_edit" name="billing_is_edit" value="0">
                    <input type="hidden" id="billing_edit_idx" name="billing_edit_idx" value="">
                    ...
                    <div class="btn-save">
                        <button type="submit" class="btn-main btn-small" id="btn_add_billing_field_cust">Save</button>
                    </div>
